...
What do scientists risk by examining Bergmann's or Allen's rule in isolation? Beyond a loss of conceptual clarity, we may miss important shifts in surface area–to–volume ratios or reach incomplete (or even misleading) conclusions about wildlife responses to temperature gradients. Two recent global analyses highlight why size and shape must be considered together.

Complementarity is the idea that wildlife can achieve comparable changes in their surface area to volume ratios through simultaneous changes in both body size and appendage length that are smaller than predicted by Bergmann's or Allen's rules in isolation [@baldwinComplementarityAllensBergmanns2023]. @baldwinComplementarityAllensBergmanns2023 found support for complementarity, as 81% of 107 bird families examined did not conform to either Bergmann’s or Allen’s rules when traits were analyzed independentl, and no families conformed to both rules simultaneously. Instead, bird families exhibited small coordinated shifts in both body size and appendage length in the directions predicted by Bergmann’s and Allen’s rules. These more modest adjustments in body plan may buffer against the fitness costs of extreme changes in a single trait, while still allowing for important changes in the surface area to volume ratio (Fig. X). For example, smaller body size could lead to reduced competitive ability [@shipleySelectionCounteractsDevelopmental2022] or constrain foraging efficiency (van Gils, CITE), and shorter appendages might **impair acoustic performance** (Sebastianelli, CITE).

@frohlichAllometryRevealsTradeoffs2023, drawing on evolutionary compromise theory, found that species often respond to warming either by decreasing body size or by increasing relative appendage length, but rarely both. Indeed, models with extensive interactions revealed codependence between size and shape in the evolutionary struggle for thermoregulation. For example, despite overall conformity to Bergmann’s rule, patterns were reversed (i.e., inverse Bergmann's rule) in birds with particular body shapes. Similarly with Allen's rule, the overall effect of temperature on relative appendage length was negative (i.e., birds exhibited inverse Allen's rule); however, once interactions with body size were included, it became clear that **this pattern applied only to small-bodied birds, whereas large-bodied birds conformed to Allen’s predictions.** Without those interaction terms conclusions would have been highly obfuscated. Finally, when predicting the temperatures experienced across species’ ranges, the strongest models supported a three-way interaction between body size, tarsus length, and beak length (see Fig 2). This was an especially clever way to reveal the multidimensional morphological response to the experienced climate envelope.

Together, these studies illustrate how joint analyses of size and shape are critical to fully understand the nuanced responses to temperature gradients. Indeed, past studies have found mixed support for Bergmann's and Allen's rules (CITE). Furthermore, a joint analysis allows for a better understanding of the correlated responses that species exhibit in the evolution of size and shape. Indeed, @baldwinComplementarityAllensBergmanns2023 showed there was a tight negative relationship between changes in body size and appendage length, with larger shifts in one trait associated with smaller shifts in the other. These results remind us that both rules are underpinned by changes in surface area–to–volume ratios.

A joint analytical approach can also allow for a deeper understanding of the evolutionary drivers behind adherence (or lack thereof) to these rules. For example, @baldwinComplementarityAllensBergmanns2023 showed that species that adhered to Bergmann's rule had less common bill shapes. They suggested this is likely because some traits are highly ecologically constrained in certain species [e.g., tarsus length in Apodiformes, bill length in Trochilidae and Rallidae; @baldwinComplementarityAllensBergmanns2023]. Similarly, the joint analysis can help generate new research questions, like why only species with certain sizes and shapes support Frohlich's tradeoff hypothesis.
