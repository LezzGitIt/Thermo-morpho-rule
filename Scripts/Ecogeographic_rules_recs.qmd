...
-Read Frohlich & Baldwin more carefully. Why do we need the thermo-morpho rule?
...
-Importance of allometry? Does this make sense for this article? Include the distinct approaches in the allometry box?

-Allometry is then accounted for in the final model proposed by Frohlich, which is a nice way to tie things together

-Allen himself in original article suggested interactions between body size & temperature
